...
let darkLayer = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(plates) {
    ...
    L.geoJson(plates, {
      ...
      pointToLayer: function(feature1) {
       console.log(plates);
        return ;
      },
      // We set the style for each circleMarker using our styleInfo function.
  ...
  function tectonicInfo(feature1) {
    return {
      color: "#B71234",
      weight: 2
    };
